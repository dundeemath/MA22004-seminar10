---
title: "Seminar 10"
subtitle: "MA22004/MA52008"
date: "2024-11-20"
author: "Dr John McDermott   •   jzmcdermott@dundee.ac.uk"
format: 
  revealjs:
    chalkboard: true
...
- Discuss `r fa("r-project")` labs at Wed workshop. 
- Discuss worksheet R at Thu workshop.
- Lab 7 due **Fri 2026-03-27** at **17:00**. 

## Upcoming - week 11

- Next seminar: review session (including mock exam solutions)
- Next Wednesday workshop (double header): final Q&A and compare cheat sheets
- Next Thursday workshop: revision
...
Shapiro--Wilk tests the null hypothesis that a given sample (of moderate size) came from a normally distributed population. Thus if $P$-value small, reject null and do not proceed. 
